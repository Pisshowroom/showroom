...
`,-1),ue=x({__name:"search",setup(ne){k({title:"Search"});const{codeArr:c,toggleCode:u}=A(),a=w(""),b=[{thumb:"profile-5.jpeg",name:"Alan Green",email:"alan@mail.com",status:"Active",statusClass:"badge badge-outline-primary"},{thumb:"profile-11.jpeg",name:"Linda Nelson",email:"Linda@mail.com",status:"Busy",statusClass:"badge badge-outline-danger"},{thumb:"profile-12.jpeg",name:"Lila Perry",email:"Lila@mail.com",status:"Closed",statusClass:"badge badge-outline-warning"},{thumb:"profile-3.jpeg",name:"Andy King",email:"Andy@mail.com",status:"Active",statusClass:"badge badge-outline-primary"},{thumb:"profile-15.jpeg",name:"Jesse Cory",email:"Jesse@mail.com",status:"Busy",statusClass:"badge badge-outline-danger"}],l=w(!1),_=C(()=>b.filter(n=>n.name.toLowerCase().includes(a.value.toLowerCase())||n.email.toLowerCase().includes(a.value.toLowerCase())||n.status.toLowerCase().includes(a.value.toLowerCase())));return(n,t)=>(r(),p("div",null,[S,e("div",$,[e("div",q,[e("div",J,[N,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[0]||(t[0]=s=>o(u)("code1"))},D)]),e("div",K,[e("div",null,[e("form",P,[e("div",R,[L(e("input",{type:"text",placeholder:"Search Attendees...",class:"form-input shadow-[0_0_4px_2px_rgb(31_45_61_/_10%)] bg-white rounded-full h-11 placeholder:tracking-wider ltr:pr-11 rtl:pl-11","onUpdate:modelValue":t[1]||(t[1]=s=>a.value=s)},null,512),[[j,a.value]]),z])]),e("div",E,[(r(!0),p(B,null,M(_.value,(s,y)=>(r(),p("div",{key:y,class:"bg-white dark:bg-[#1b2e4b] rounded-xl shadow-[0_0_4px_2px_rgb(31_45_61_/_10%)] p-3 flex items-center justify-between text-gray-500 font-semibold min-w-[625px] hover:text-primary transition-all duration-300 hover:scale-[1.01]"},[e("div",F,[e("img",{src:`/assets/images/${s.thumb}`,alt:"",class:"w-8 h-8 rounded-md object-cover"},null,8,G)]),e("div",null,g(s.name),1),e("div",null,g(s.email),1),e("div",{class:d(["badge border-2 border-dashed",s.statusClass])},g(s.status),3),I]))),128))])])]),o(c).includes("code1")?(r(),h(v,{key:0},{default:m(()=>[O]),_:1})):f("",!0)]),e("div",T,[e("div",U,[H,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[2]||(t[2]=s=>o(u)("code2"))},W)]),e("div",X,[e("form",null,[e("div",{class:d(["search-form-overlay relative border border-white-dark/20 rounded-md h-12 w-full",l.value&&"input-focused"]),onClick:t[4]||(t[4]=s=>l.value=!0)},[e("input",{type:"text",placeholder:"Search...",class:d(["form-input bg-white h-full placeholder:tracking-wider hidden ltr:pl-12 rtl:pr-12 peer",{"!block":l.value}]),onBlur:t[3]||(t[3]=s=>l.value=!1)},null,34),e("button",{type:"submit",class:d(["text-dark/70 absolute ltr:right-1 rtl:left-1 inset-y-0 my-auto w-9 h-9 p-0 flex items-center justify-center peer-focus:text-primary",{"ltr:!right-auto ltr:left-1 rtl:right-1":l.value}])},Z,2)],2)])]),o(c).includes("code2")?(r(),h(v,{key:0},{default:m(()=>[ee]),_:1})):f("",!0)]),e("div",te,[e("div",se,[re,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[5]||(t[5]=s=>o(u)("code3"))},ae)]),le,o(c).includes("code3")?(r(),h(v,{key:0},{default:m(()=>[ie]),_:1})):f("",!0)])])]))}});export{ue as default};
