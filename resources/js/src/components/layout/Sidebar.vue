        ...
        >
          <ul class="relative font-semibold space-y-0.5 p-4 py-0">
            ...
            <li class="nav-item">
              <ul>
                <li class="nav-item">
                  <router-link to="/admin/refund/index" class="group" @click="toggleMobileMenu">
                    <div class="flex items-center">
                      <svg
                        class="group-hover:!text-primary shrink-0"
                        width="20"
            ...
            <li class="nav-item">
              <ul>
                <li class="nav-item">
                  <router-link to="/admin/category/index" class="group" @click="toggleMobileMenu">
                    <div class="flex items-center">
                      <svg
                        class="group-hover:!text-primary shrink-0"
                        width="20"
            ...
            <li class="nav-item">
              <ul>
                <li class="nav-item">
                  <router-link to="/admin/sub-category/index" class="group" @click="toggleMobileMenu">
                    <div class="flex items-center">
                      <svg
                        class="group-hover:!text-primary shrink-0"
                        width="20"
            ...
            <li class="nav-item">
              <ul>
                <li class="nav-item">
                  <router-link to="/admin/setting/index" class="group" @click="toggleMobileMenu">
                    <div class="flex items-center">
                      <svg
                        class="group-hover:!text-primary shrink-0"
                        width="20"
            ...
            <li class="nav-item">
              <ul>
                <li class="nav-item">
                  <router-link to="/admin/ads/index" class="group" @click="toggleMobileMenu">
                    <div class="flex items-center">
                      <svg
                        class="group-hover:!text-primary shrink-0"
                        width="24"
