            ...
            <div class="breadcrumbs-div">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li><a class="font-xs color-gray-500" href="{{ route('buyer.about') }}{{ Auth::check() && preg_match('/PiBrowser/i', request()->header('User-Agent')) ? '?auth=' . base64_encode(Auth::user()->uid) : '' }}">Tentang Kami</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mt-20">
                            <div class="col-lg-6">
                                <p class="font-sm font-medium color-gray-700 mb-15">Ecom memperluas jejak global,
                                    memberikan pengalaman menghibur yang disesuaikan untuk setiap pengguna. Cabang
                                    memperluas keduanya
