...
@section('dashboard')
    <section class="content-main">
        <div class="content-header">
            ...
            <div> <button type="button" class="btn btn-xs-danger" data-bs-toggle="modal" data-bs-target="#deleteAddressSeller">
                    Hapus Alamat
                </button>
            </div>
        </div>
        ...
        <div class="modal fade" id="deleteAddressSeller" tabindex="-1" aria-labelledby="deleteAddressSellerLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-bottom-0">
                        <h1 class="modal-title fs-5 text-dark" id="deleteAddressSellerLabel">Hapus Alamat</h1>
                    ...
                    <div class="modal-footer border-top-0">
                        ...
                        <a class="btn btn-xs-danger" style="background-color:#dc3545 !important;"
                            href="{{ route('dashboardSeller.deleteAddressSeller', ['id' => $data->id]) }}{{ Auth::check() && preg_match('/PiBrowser/i', request()->header('User-Agent')) ? '?auth=' . base64_encode(Auth::user()->uid) : '' }}">Hapus
                        </a>
                    </div>
                </div>
            </div>
