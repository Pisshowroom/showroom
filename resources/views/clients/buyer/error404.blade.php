        ...
        <section class="section-box shop-template mt-60">
            <div class="container">
                <div class="text-center mb-150 mt-50">
                    ...
                    <div class="mt-15"> <a class="btn btn-buy w-auto arrow-back" href="{{ route('buyer.home') }}{{ Auth::check() && preg_match('/Chrome/i', request()->header('User-Agent')) ? '?auth=' . base64_encode(Auth::user()->uid) : '' }}">Kembali ke Beranda</a></div>
                </div>
            </div>
        </section>
    </main>
