                                        ...
                                        <div class="card-grid-style-3">
                                            <div class="card-grid-inner">
                                                ...
                                                <div class="info-right"><a class="font-xs color-gray-500"
                                                        href="{{ route('buyer.detailSeller', ['slug' => $product->seller ? $product->seller->seller_slug : 'bobsmith']) }}">{{ $product->seller ? $product->seller->name ?? '' : '' }}</a><br><a
                            ...
                            <div class="col-lg-6">
                                <div class="product-info">
                                    ...
                                    <div class="info-by"><span
                                            ...
                                            href="{{ route('buyer.detailSeller', ['slug' => 'sds']) }}"> Ecom Tech</a>
                                        <div class="rating d-inline-block"><img
                                                src="{{ asset('ecom/imgs/template/icons/star.svg') }}"
                                                alt="Ecom"><img
                                                src="{{ asset('ecom/imgs/template/icons/star.svg') }}"
