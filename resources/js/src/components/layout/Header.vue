  ...
  <header :class="{ dark: store.semidark && store.menu === 'horizontal' }">
    <div class="shadow-sm">
      ...
      >
        ...
        >
          <!-- * Auto Width Pushing into right the Others -->
            ...
            >
              <button type="button" class="relative group block">
                <img
                  ...
                  src="/assets/images/user-profile-2.svg"
                  alt=""
                />
              </button>
                  ...
                  <li>
                    <div class="flex items-center px-4 py-4">
                      ...
                      <div class="ltr:pl-4 rtl:pr-4 truncate">
                        <h4 class="text-base">{{ user.username ?? "-" }}</h4>
                        <a
        ...
        <li class="menu nav-item relative">
          ...
          <ul class="sub-menu">
            ...
            <li class="relative">
              ...
              >
                <li>
                  <router-link to="/admin/pages/error404" target="_blank">{{
                    $t("404")
                  }}</router-link>
                </li>
                <li>
            ...
            <li class="relative">
              <a href="javascript:;"
                >{{ $t("lockscreen") }}
                <div class="ltr:ml-auto rtl:mr-auto rtl:rotate-180">
                  <!-- <div class="dropdown shrink-0" v-if="user != null"> -->
                  <!-- Do Logout Ke 2 -->
                  <div class="dropdown shrink-0">
                    <Popper
                      :placement="
