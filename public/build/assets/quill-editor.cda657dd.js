...
<\/script>
`,-1),U={class:"panel"},D={class:"flex items-center justify-between mb-5"},j=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"With Tooltip",-1),B=s('<span class="flex items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2"><path d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path opacity="0.5" d="M13.9868 5L10.0132 19.8297" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M7.00005 7.82959L5.30358 9.35641C3.76102 10.7447 2.98975 11.4389 2.98975 12.3296C2.98975 13.2203 3.76102 13.9145 5.30358 15.3028L7.00005 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg> Code </span>',1),Q=[B],T={class:"mb-5"},I=e("pre",null,`<!-- with tooltip -->
...
<\/script>
`,-1),z=C({__name:"quill-editor",setup($){x({title:"Quill Editor"});const{codeArr:l,toggleCode:n}=q(),f=a({modules:{toolbar:[[{header:[1,2,!1]}],["bold","italic","underline","link"],[{list:"ordered"},{list:"bullet"}],["clean"]]},placeholder:""}),o=a(`<h1>This is a heading text...</h1>
            <br />
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dui arcu, pellentesque id mattis sed, mattis semper erat. Etiam commodo arcu a mollis consequat. Curabitur pretium auctor
              tortor, bibendum placerat elit feugiat et. Ut ac turpis nec dui ullamcorper ornare. Vestibulum finibus quis magna at accumsan. Praesent a purus vitae tortor fringilla tempus vel non
            ...
            <p>
              ...
              leo venenatis pretium. Sed aliquet sem nunc, ut iaculis dolor consectetur et. Vivamus ligula sapien, maximus nec pellentesque ut, imperdiet at libero. Vivamus semper nulla lectus, id
              dapibus nulla convallis id. Quisque elementum lectus ac dui gravida, ut molestie nunc convallis. Pellentesque et odio non dolor convallis commodo sit amet a ante.
            </p>`);return(F,t)=>(r(),w("div",null,[k,e("div",_,[V,e("div",P,[e("div",A,[e("div",M,[y,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[0]||(t[0]=u=>i(n)("code1"))},S)]),e("div",L,[d(i(p),{ref:"editor1",value:o.value,"onUpdate:value":t[1]||(t[1]=u=>o.value=u),options:f.value,style:{"min-height":"200px"}},null,8,["value","options"])]),i(l).includes("code1")?(r(),v(m,{key:0},{default:b(()=>[E]),_:1})):h("",!0)]),e("div",U,[e("div",D,[j,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[2]||(t[2]=u=>i(n)("code2"))},Q)]),e("div",T,[d(i(p),{ref:"editor2",value:c.value,"onUpdate:value":t[3]||(t[3]=u=>c.value=u),options:g.value,style:{"min-height":"200px"}},null,8,["value","options"])]),i(l).includes("code2")?(r(),v(m,{key:0},{default:b(()=>[I]),_:1})):h("",!0)])])])]))}});export{z as default};
