...
<\/script>
`,-1),j={class:"panel"},U={class:"flex items-center justify-between mb-5"},S=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"Multiple File",-1),E=t('<span class="flex items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2"><path d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path opacity="0.5" d="M13.9868 5L10.0132 19.8297" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M7.00005 7.82959L5.30358 9.35641C3.76102 10.7447 2.98975 11.4389 2.98975 12.3296C2.98975 13.2203 3.76102 13.9145 5.30358 15.3028L7.00005 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg> Code </span>',1),B=[E],P=t('<div class="mb-5"><div class="custom-file-container" data-upload-id="mySecondImage"><div class="label-container"><label>Upload </label> <a href="javascript:;" class="custom-file-container__image-clear" title="Clear Image">\xD7</a></div><label class="custom-file-container__custom-file"><input type="file" class="custom-file-container__custom-file__custom-file-input" multiple><input type="hidden" name="MAX_FILE_SIZE" value="10485760"><span class="custom-file-container__custom-file__custom-file-control ltr:pr-20 rtl:pl-20"></span></label><div class="custom-file-container__image-preview"></div></div></div>',1),A=e("pre",null,`<!-- multiple file -->
...
<\/script>
`,-1),N=_({__name:"file-upload",setup(D){f({title:"File Upload"});const{codeArr:a,toggleCode:o}=u();return v(()=>{new c("myFirstImage",{images:{baseImage:"/assets/images/file-preview.svg",backgroundImage:""}}),new c("mySecondImage",{images:{baseImage:"/assets/images/file-preview.svg",backgroundImage:""},multiple:!0})}),(V,i)=>(l(),h("div",null,[g,e("div",w,[b,e("div",k,[e("div",C,[e("div",x,[y,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:i[0]||(i[0]=m=>s(o)("code1"))},F)]),M,s(a).includes("code1")?(l(),n(r,{key:0},{default:p(()=>[L]),_:1})):d("",!0)]),e("div",j,[e("div",U,[S,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:i[1]||(i[1]=m=>s(o)("code2"))},B)]),P,s(a).includes("code2")?(l(),n(r,{key:0},{default:p(()=>[A]),_:1})):d("",!0)])])])]))}});export{N as default};
