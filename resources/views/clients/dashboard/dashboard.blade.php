                                ...
                                <div class="new-member-list">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center"><img class="avatar"
                                                src="{{ asset('ecom_dashboard/imgs/people/avatar4.jpg') }}" alt="">
                                            <div>
                                                <h6>Patric Adams</h6>
                                                <p class="text-muted font-xs">Sanfrancisco</p>
                                            </div>
                                        </div><a class="btn btn-xs" href="#"><i class="material-icons md-add"></i>
                                            Add</a>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center"><img class="avatar"
                                                src="{{ asset('ecom_dashboard/imgs/people/avatar2.jpg') }}" alt="">
                                            <div>
                                                <h6>Dilan Specter</h6>
                                                <p class="text-muted font-xs">Sanfrancisco</p>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center"><img class="avatar"
                                                src="{{ asset('ecom_dashboard/imgs/people/avatar3.jpg') }}" alt="">
                                            <div>
                                                <h6>Tomas Baker</h6>
                                                <p class="text-muted font-xs">Sanfrancisco</p>
                                            </div>
