            ...
            <div class="col-lg-6">
                <div class="card card-body mb-4">
                    <article class="icontext"><span class="icon icon-sm rounded-circle bg-success-light"><i
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">Total Pesanan</h6><span>53.668</span><span class="text-sm">Tidak termasuk
            ...
            <div class="col-lg-6">
                <div class="card card-body mb-4">
                    <article class="icontext"><span class="icon icon-sm rounded-circle bg-warning-light"><i
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">Barang</h6><span>9.856</span><span class="text-sm">berhasil sampai</span>
                        </div>
                    </article>
                </div>
            </div>
                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a class="btn btn-xs" href="{{ route('dashboard.detailOrder') }}">Detail</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                        <div class="form-check">
