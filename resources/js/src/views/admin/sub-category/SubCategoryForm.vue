  ...
  <div>
    ...
    >
      <li>
        <router-link
          ...
          >Master Data Sub Kategori</router-link
        >
      </li>
    ...
    <div class="pt-3">
      ...
      >
        ...
        >
          <p class="pb-3 text-lg font-semibold">Data Sub Kategori</p>
          <div class="flex-1">
...
onMounted(async () => {
  ...
  if (route.params.id) {
    form.value = (
      await axios.get(`/admin/sub-categories/${route.params.id}`)
    ).data;
  }
});
...
const handleSubmit = async () => {
  ...
  if (isFormCorrect) {
    ...
    axios
      .post("/admin/sub-categories", fform)
      .then((res) => {
        ...
        if (res.data.message) {
          ...
          router.push({ name: "admin.sub-category.index" });
...
const deleteCategory = () => {
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.value) {
        axios.delete(`/admin/sub-categories/${form.value.id}`).then((res) => {
          toast.fire("Sub Kategori berhasil dihapus.");
          router.push("/admin/sub-category/index");
        });
