<template>
  <div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-6">
      <div
        class="panel py-6 bg-gradient-to-r from-cyan-500 to-cyan-400 text-white"
      >
      ...
      <div
        class="panel py-6 bg-gradient-to-r from-green-500 to-green-400 text-white"
      >
        <div class="flex justify-between">
          <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">
      ...
      <div
        class="panel py-6 bg-gradient-to-r from-yellow-500 to-yellow-400 text-white"
      >
        <div class="flex justify-between">
          <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">
            Jumlah Produk
      ...
      <div
        class="panel py-6 bg-gradient-to-r from-purple-500 to-purple-400 text-white"
      >
        <div class="flex justify-between">
    ...
    <div class="grid xl:grid-cols-1 gap-6 mb-6">
      <div class="panel h-full xl:col-span-2">
        ...
        >
          <h5 class="font-semibold text-lg">Aktivitas Pesanan</h5>
          <div class="dropdown ltr:ml-auto rtl:mr-auto">
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M9.60235 4.59668L6.24576 7.47376L2.88916 4.59668"
                    stroke="#0E1726"
                    stroke-width="0.719271"
              ...
              <template #content="{ close }">
                <ul @click="close()" class="whitespace-nowrap">
                  ...
                  <li>
                    <button @click="getActivity('monthly')">Mingguan</button>
                  </li>
                  <li>
                    <button @click="getActivity('yearly')">Bulanan</button>
                  </li>
                </ul>
              </template>
            </Popper>
        ...
        <div class="relative">
          ...
          <!-- v-if="activityChart.xaxis.categories.length > 0"
                     -->
          <!-- loader -->
