            ...
            <div class="breadcrumbs-div mb-0">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li><a class="font-xs color-gray-500" href="{{ route('buyer.contact') }}{{ Auth::check() && preg_match('/PiBrowser/i', request()->header('User-Agent')) ? '?auth=' . base64_encode(Auth::user()->uid) : '' }}">Kontak Kami</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center mb-30">
                            ...
                            <p class="font-sm color-gray-700 mb-5">Bicaralah dengan tim kami.</p><a class="font-sm color-gray-900"
                                href="mailto:Pisshowroom@gmail.com">Pisshowroom@gmail.com</a>
                        </div>
                        <div class="col-lg-3 text-center mb-30">
