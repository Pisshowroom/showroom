    ...
    <div class="container">
        <div class="main-header">
            <div class="header-left">
                <div class="header-logo"><a href="{{ route('buyer.home') }}{{ Auth::user() ?  '?auth='.base64_encode(Auth::user()->uid) : '' }}"><img alt="Logo Pishop"
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <nav class="mt-15">
                        <ul class="mobile-menu font-heading">
                            <li><a class="@yield('privacyPolicy')" href="{{ route('buyer.home') }}{{ Auth::user() ?  '?auth='.base64_encode(Auth::user()->uid) : '' }}">Beranda</a></li>
                            @guest
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateURL() {
                ...
                window.location = url+'{{ Auth::user() ?  '?auth='.base64_encode(Auth::user()->uid) : '' }}';
