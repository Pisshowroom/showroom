                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="dropdown"><a class="btn btn-light rounded btn-sm font-sm" href="#"
                                    ...
                                    <div class="dropdown-menu"><a class="dropdown-item" href="{{ route('dashboardSeller.detailTransaction') }}">Detail</a><a
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="dropdown"><a class="btn btn-light rounded btn-sm font-sm" href="#"
                                        data-bs-toggle="dropdown"><i class="material-icons md-more_horiz"></i></a>
                                    <div class="dropdown-menu"><a class="dropdown-item" href="{{ route('dashboardSeller.detailTransaction') }}">View
                                            detail</a><a
                                            class="dropdown-item text-danger" href="#">Batalkan</a></div>
                                </div>
                            </td>
